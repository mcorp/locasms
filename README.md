...
> :warning: After `Jun 1st 2015` the base IP of the service will change as notived on this [issue](https://github.com/mcorp/locasms/issues/4). If you don't upgrade to version `0.2.0` your app will stop delivering SMS
